...
STAGE_MESSAGES = {
    ...
    JobStage.TRANSCRIPT_FOUND: "Getting transcript...",
    ...
    JobStage.CLEANING_TEXT: "Preparing content...",
    JobStage.REMOVING_REPETITION: "Preparing content...",
    JobStage.VALIDATING_TEXT: "Preparing content...",
    JobStage.GENERATING_IMPORTANT_CONTENT: "Generating article...",
    JobStage.TEXT_READY: "Text Ready",
    JobStage.SAVING: "Saving results...",
    JobStage.TRANSLATING: "Preparing translation...",
    JobStage.GENERATING_VOICE: "Preparing audio...",
    ...
    with JOBS_LOCK:
        ...
        if job_id in VIDEO_JOBS:
            ...
            job["error"] = {
                ...
                "message": clean_msg,
                "retryable": retryable,
                "stage": job.get("stage", JobStage.FAILED),
                "job_id": job_id,
            }
            job["status"] = "failed"
